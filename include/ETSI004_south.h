# define PROGRAM_ETSI004_SOUTH_H_
...
class ETSI004South : public Block {

public:

    ETSI004South(std::initializer_list<Signal *> InputSig, std::initializer_list<Signal *> OutputSig) :Block(InputSig, OutputSig) {};
